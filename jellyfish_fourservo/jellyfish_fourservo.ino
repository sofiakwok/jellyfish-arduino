...
double beta_1_1_offset = 5;
double beta_2_1_offset = 7;
...
void setup() {
  ...
  fin1_1.attach(12); // for controlling rudder 1
  fin2_1.attach(13); // for controlling rudder 2
  stroke.write(0);
  fin1.write(180 - beta_1_offset); //because fin1 is flipped
  fin2.write(0 + beta_2_offset);
  fin1_1.write(180 - beta_1_1_offset); //because fin1 is flipped
  fin2_1.write(0 + beta_2_1_offset);
  Serial.begin(9600);
}
...
void loop() {
  ...
  while(startLoop){
    ...
    {       
      ...
      fin1_1.write(180 - beta_1_1 - beta_1_1_offset);
      fin2_1.write(beta_2_1 + beta_2_1_offset);                
      delay(15);                   
    } 
    Serial.print("\n Loop 2 \n");
...
void update_rudders(double theta, double alpha_1, double alpha_2){
  bool left;
  bool outer;
  beta_1 = beta_calc(alpha_1, theta, left=true, outer=false);
  //Serial.print((String)"(alpha_1: " + alpha_1 + " theta: " + theta + " beta_1: " + beta_1 ")");
  beta_2 = beta_calc(alpha_2, theta, left=false, outer=false);

  beta_1_1 = beta_calc(alpha_1, theta, left=true, outer=true);
  beta_2_1 = beta_calc(alpha_2, theta, left=false, outer=true);
}

double beta_calc(double alpha_deg, double theta_deg, bool left, bool outer){
